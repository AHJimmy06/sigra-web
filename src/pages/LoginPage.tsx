...
export function LoginPage() {
  ...
  return <main className="grid min-h-screen place-items-center bg-muted/40 p-4"><form onSubmit={submit} onInvalid={setSpanishValidationMessage} onInput={clearSpanishValidationMessage} className="w-full max-w-sm rounded-2xl border bg-card p-7 shadow-sm">
